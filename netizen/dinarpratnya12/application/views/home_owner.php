	...
	<body>
			...
			<div class="collapse navbar-collapse" id="navbarColor02">
			  	<ul class="navbar-nav mr-auto">
				    <li class="nav-item active">
				      <a class="nav-link" href="<?php echo base_url('Home/owner'); ?>">Home <span class="sr-only">(current)</span></a>
				    </li>
				    <li class="nav-item dropdown">
				    	<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
       					...
       					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
       						<a class="dropdown-item" href="<?php echo base_url('Buku/index_owner'); ?>">Data Buku</a>
       						<a class="dropdown-item" href="<?php echo base_url('Transaksi/index_owner'); ?>">Data Transaksi</a>
       					</div>
				    </li>
			  	</ul>
		...
		<div class="container">
			<div class="jumbotron">
				...
				<p class="lead">
					<a class="btn btn-primary btn-lg" href="<?php echo base_url('Buku/index_owner'); ?>">
