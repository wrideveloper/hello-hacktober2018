...
<html lang="en">
	...
	<body>
		<div class="container">
			<center><h1><b>Edit Data Penerbit</b></h1></center>
			<center><hr class="my-4"></center>
			<center><h5>Silahkan Edit Penerbit di Bawah Ini</h5></center>
			...
			<div class="card w-75">
				...
				<div class="card-body">
					<?php foreach ($penerbit as $key) { ?>
						<?php echo form_open('Penerbit/aksi_update/'.$key->id); ?>
							<div class="form-group">
								<label class="col-sm-6 col-form-label" for="id">ID Penerbit</label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="nama" class="form-control" value="<?php echo $key->nama_penerbit; ?>">
								</div>
							</div>
							<div class="form-group">
			...
			<a class="btn btn-danger" href="<?php echo base_url('Penerbit/index'); ?>">
