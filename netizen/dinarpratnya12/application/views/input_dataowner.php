...
<html lang="en">
	...
	<body>
		<div class="container">
			<center><h1><b>Input Data Owner</b></h1></center>
			<center><hr class="my-4"></center>
			<center>Silahkan Input Data Owner Baru</center>
			...
			<div class="card border-primary w-100">
				<div class="card-header bg-primary text-white">
					<h4 class="card-title">Input Data Owner Baru</h4>
				</div>
				<div class="card-body">
					<?php echo form_open('Member/aksi_input_owner'); ?>
