                ...
                <ul class="collapsible collapsible-accordion">
                    <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-briefcase"></i>Laporan PO<i class="fa fa-angle-down rotate-icon"></i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="<?= base_url() ?>Prints/" class="waves-effect">Masukkan data PO</a>
                                </li>
                                <li><a href="#" class="waves-effect">List Laporan PO </a>
                                </li>
                                <li><a href="<?= base_url() ?>Prints/viewproduk" class="waves-effect">Tambah produk</a>
                                </li>
                                <li><a href="<?= base_url() ?>Prints/tambahcustomer" class="waves-effect">Tambah customer</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-briefcase"></i>Laporan SO<i class="fa fa-angle-down rotate-icon"></i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="<?= base_url() ?>Prints/viewdo" class="waves-effect">Tambah surat DO</a>
                                </li>
                                <li><a href="#" class="waves-effect">List Laporan Surat SO/DO</a>
                                </li>
                            </ul>
                        </div>
                    </li>
